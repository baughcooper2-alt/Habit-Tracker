          ...
          {editing ? (
            <div className="mt-1 flex items-center gap-1.5">
              <input
                ...
                onBlur={commitEdit}
                className="w-20 rounded-lg border border-cocoa/20 bg-black/25 px-2 py-1 text-sm font-semibold text-ink outline-none focus:border-ink/40"
              />
      ...
      <div className="mt-3 flex flex-wrap gap-1.5">
        {habit.quickAdds.map((amt) => (
          <button
            ...
            className="rounded-full bg-white/10 px-3 py-1 text-xs font-bold text-ink shadow-sm active:scale-95"
          >
            +{amt}
          </button>
        ))}
        {value > 0 && (
          <button
            ...
            className="rounded-full bg-white/10 px-3 py-1 text-xs font-bold text-cocoa active:scale-95"
          >
